...
namespace ErrorlineSystem.DataContext.Migrations
{
    ...
    [Migration("20250401084530_IssueChanges")]
    partial class IssueChanges
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ErrorlineSystem.DataContext.Entities.Issue", b =>
                {
                    b.HasOne("ErrorlineSystem.DataContext.Entities.User", "AssignedUser")
                        .WithMany()
                    ...
                    b.HasOne("ErrorlineSystem.DataContext.Entities.IssueType", "IssueType")
                        .WithMany("Issues")
